...
int main(int argc, char *argv[]) {
	 ...
	 system("sudo umount /home/vli/debugfs");
...
int CreatEnv(){
	...
	///////////////////////creat /home/vli/debugfs/////////////////////
	if((pp=popen("ls /home/vli | grep debugfs","r")) == NULL){
		std::cout << "Popen() error: " << std::endl;
	}

	if(fgets(Shellbuf,sizeof(Shellbuf),pp) == NULL){
		system("mkdir /home/vli/debugfs");
	}

	///////////////////////mount debugfs////////////////////////////////
	if((pp=popen("sudo ls /home/vli/debugfs/ | wc -l","r")) == NULL){
		std::cout << "Popen() error: " << std::endl ;
	}

	if (atoi(fgets(Shellbuf,sizeof(Shellbuf),pp)) == 0){
		system("sudo mount -t debugfs debug /home/vli/debugfs");
	} else{
		return 1;
	}
	...
	system("sudo chown -R www-data:www-data /home/vli/debugfs");
